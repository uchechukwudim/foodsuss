...
<div class="container clearfix">
    ...
    <div id="personalsProfile">
            <ul>
                ...
                <li id="P_aboutme" onclick="getRestaurantProfileAbouteMe('<?php echo $userDetails[0]['user_type'] ?>')">About Me</li>
						 ...
						 <ul>
							...
							<ul class="recipeNav">
                                                ...
                                                <div class="post_comments">
                                                                ...
                                                                <div class="post_comments_box_profile_photo"><?php echo $this->checkUserPicture($userDetails[0]['picture'], 35, 35)?></div>
