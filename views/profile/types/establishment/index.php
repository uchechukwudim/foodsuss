...
<div class="container clearfix">
    ...
    <div id="personalsProfile">
            <div id="Me">
                <div id="MeHeader" onclick="getProfileAbouteMe()">Me <img style="margin-left: 218px;" src="<?php echo URL ?>pictures/profile/avater.jpg" width="20" height="20"></div>
            ...
            <div id="mycookbook">
                <div id="mycookbookHeader" onclick="getProfileMyCookBook()">My CookBook <img style="margin-left: 150px;" src="<?php echo URL ?>pictures/profile/ENRI_COOKBOOK.png" width="20" height="20"></div>
            <?php for($looper = 0; $looper < count($myCookBook); $looper++){ ?>
                <div class="myCBHolder">
                    <div class="myCBImage"> <img src="data:image/jpeg;base64,<?php echo base64_encode($myCookBook[$looper]['recipe_photo']) ?>" width="30" height="30" alt=""></div>
                    <div class="myCBRecipeTitle"><?php echo $myCookBook[$looper]['recipe_title'] ?></div>
                   <div class="myCBFood"><img src="data:image/jpeg;base64,<?php echo base64_encode($myCookBook[$looper]['food_picture']) ?>" width="20" height="20" alt="" title="<?php echo $myCookBook[$looper]['food_name']?>">  <span class="myCBFoodLocation"><img src="data:image/jpeg;base64,<?php echo base64_encode($myCookBook[$looper]['flag_picture']) ?>" width="20" height="20" alt="" title="<?php echo $myCookBook[$looper]['country_names']?>"></span></div>
        ...
        <div id="mycookBox">
            ...
            <div id="friendsFollowers">
                <div id="friendsFollowersHeader" onclick="getProfileFriendsFollow()">Friends/Followers <img style="margin-left: 110px;" src="<?php echo URL ?>pictures/profile/ENRI_friends_icon.png" width="20" height="20"></div>
                 ...
                 ?>
                <div class="FFHolder">
                    <div class="friendPic"><?php echo $this->checkUserPicture($friendsFollowers[$looper]['picture'], 100, 100) ?></div>
                    <div class="FriendName"><b><a href="<?php echo URL ?>profile/user/<?php echo $this->encrypt($this->getfriendUserId($friendsFollowers[$looper]['user_id'], $friendsFollowers[$looper]['user_friend_id'], $userId )) ?>" ><?php echo $friendsFollowers[$looper]['FirstName']." ". $friendsFollowers[0]['LastName'] ?> </a></b></div>
    ...
    Adds
      ...
      <div id="profilDetailsHolder">
          ...
          <div id="updateInfo" title="change profile picture">Change Picture </div> <div onclick="getCoverPicFromSystem()" id="updateCover">Change Cover</div><input type="file" name="file" id="file"/><input type="file" name="file1" id="file1"/>
          <div id="AjaximageLoader"><img src="<?php echo URL ?>pictures/profile/transparentbck_ajax-loader.gif" width="60" height="60"></div>
                ...
                <div id='LOAD'>
                        <div id="myCookBookHolder">
                             <div id="myCookBookHolderHeader"><img src="<?php echo URL ?>pictures/profile/cookbook.png" width="30" height="30"> <b>My CookBook</b></div>
                                  <?php for($looper =0; $looper<count($myCookBook); $looper++){?>
                                    <div class="feed">
